...
namespace Flow.Net.Sdk.Client.Http
{
    public class FlowHttpClient : IFlowClient
    {
        ...
        // public async Task<FlowTransactionResult> GetTransactionResulForTxIdAsync(string txId)
        // {
        //     try
        //     {
        //         var response = await _flowApiV1.ResultsAsync(txId, null, null);
        //         return response;
        //     }
        //     catch (Exception e)
        //     {
        //         throw new FlowException("Get transaction result for transaction hash code error.");
        //     }
        // }
